...
window.angular.module('ngff.controllers', ['ngff.controllers.header','ngff.controllers.index', 'ngff.controllers.nfl', 'ngff.controllers.leagues', 'ngff.controllers.leagues', 'ngff.controllers.fantasyTeams', 'ngff.controllers.players']);
